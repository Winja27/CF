...
def data_read(ratings_address, movie_address):
    ...
    folds = chunks(rating_index_set, 1)
...
def neighbors_require(num):
    neighbors_require = [i for i in range(5, 5*(num+1), 5)]
...
def prediction(folds, df_uir, df_ave_rating, pairs):
